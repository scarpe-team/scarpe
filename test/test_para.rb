...
class TestWebviewPara < ScarpeWebviewTest
  ...
  def test_renders_paragraph
    para = Scarpe::Webview::Para.new(@default_properties.merge("text_items" => ["Hello World"]))
  ...
  def test_renders_paragraph_with_collection_of_arguments
    ...
    para = Scarpe::Webview::Para.new(@default_properties.merge("text_items" => items))
  ...
  def test_renders_a_magenta_paragraph
    para = Scarpe::Webview::Para.new(@default_properties.merge("stroke" => [255, 0, 255, 255]))
  ...
  #   para = Scarpe::Webview::Para.new(@default_properties.merge("class" => "sea", "stroke" => "blue"))
  #
